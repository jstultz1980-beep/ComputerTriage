function Global:Get-CSIChocolateyCommand {
...
function Global:Invoke-InstallChocolatey {
    ...
    $existing = Get-CSIChocolateyCommand
    ...
    $confirm = Read-CSIInput "Install Chocolatey now? Type Y to continue"
    ...
    try {
        ...
        $installed = Get-CSIChocolateyCommand
...
param(
    ...
    if(!$Query){
        $Query = Read-CSIInput "Package search term"
    }
    ...
    $choice = Read-CSIInput "Select package to install"
    ...
    $confirm = Read-CSIInput "Install this package? Type Y to continue"
