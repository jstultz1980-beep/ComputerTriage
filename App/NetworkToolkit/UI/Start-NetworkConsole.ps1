...
function Global:Start-NetworkConsole {
    ...
    while ($true) {
        ...
        try {
            $choice = Read-NTKInput "Select option"
        }
        ...
        if($selected.RequiresAdmin -and !(Test-NTKAdministrator)){
            ...
            [void](Start-NTKElevatedTool $selected.Name)
        ...
        try {
            ...
            Invoke-NTKCommand $selected.Name
