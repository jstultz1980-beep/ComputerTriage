...
function Global:Invoke-PrintQueueTools {
    ...
    while($true){
        ...
        $choice = Read-NTKInput "Select print task"
        ...
        switch($choice){
            ...
            "1" {
                ...
                $dataRoot = Join-Path $NTKPaths.Data "PrintQueues"
...
function Global:Invoke-StaleLocalPrinterCleanup {
    ...
    $choice = Read-NTKInput "Items to clean"
    ...
    Write-Host ""
    $confirm = Read-NTKInput "Type CLEAN to remove selected artifacts"
