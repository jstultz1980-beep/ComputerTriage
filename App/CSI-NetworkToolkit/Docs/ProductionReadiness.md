...
- **Directory**, **Security**, **Wi-Fi**, **Print**, **Files**, **Robocopy**, **Software**, **Software Keys**, **Clean Up**, **Apps**, **Choco**, **Sysinternals**, and **Reports** each group related tools by field workflow.
