...
## Acceptance Criteria
- [ ] Technician report is generated.
- [ ] Escalation/AI handoff report is generated or explicitly deferred.
- [ ] Reports include evidence limitations.
- [ ] Report outputs are validated from a current triage bundle.
