...
|---|---|---|---|
| `TASK-0043-Client-Data-Transfer` | Codex | Active | Add a Settings-page workflow to transfer client diagnostic data to another toolkit copy. |
...
- Current active task is TASK-0043.
