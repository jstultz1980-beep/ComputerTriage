...
## Objective
Create a concise intended-state architecture, normalize terminology while preserving ARGUS, simplify roadmap/queue roles, and reduce duplicated governance text without weakening controls.
