...
## Acceptance Criteria
- [ ] Analyze workflow can run or open the expected analysis/report outputs.
- [ ] Missing/limited evidence states are visible and understandable.
- [ ] Normal use does not require console commands.
